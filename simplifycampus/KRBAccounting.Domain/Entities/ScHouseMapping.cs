...
namespace KRBAccounting.Domain.Entities
{
    public class ScHouseMapping
    {
        ...
        [ForeignKey("HouseGroupId")]
        public virtual ScHouseGroup HouseGroups { get; set; }
        [ForeignKey("ClassId")]
        ...
        [NotMapped]
        public IEnumerable<ScHouseMapping> HouseMappings { get; set; }
        ...
        [NotMapped]
        public int OLDHouseGroupId { get; set; }
    }
}
