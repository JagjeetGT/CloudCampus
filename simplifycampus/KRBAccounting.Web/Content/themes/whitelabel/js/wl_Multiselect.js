    ...
    return this.each(function () {
        ...
        if ($.fn.wl_Multiselect.methods[method]) {
            ...
            if ($this.data('wl_Multiselect')) {
                opts = $.extend({}, $this.data('wl_Multiselect'), method);
            } else {
                opts = $.extend({}, $.fn.wl_Multiselect.defaults, method, $this.data());
            }
        } else {
        ...
        if (!$this.data('wl_Multiselect')) {
            ...
            $('<div class="comboselectbox"><div class="combowrap"><ul class="comboselect wsws"></ul></div><div class="comboselectbuttons"><a class="add btn-white"></a><a class="addall btn-white"></a><a class="removeall btn-white"></a><a class="remove btn-white"></a></div><div class="combowrap"><ul class="comboselect"></ul></div></div>').insertAfter($this);
