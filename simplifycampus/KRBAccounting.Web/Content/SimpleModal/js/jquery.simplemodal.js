...
(function (d) {
    var k = d.browser.msie && parseInt(d.browser.version) === 6 && typeof window.XMLHttpRequest !== "object",
        ...
        l = null,
        f = [];
    d.simplemodal = function (a, b) {
        return d.simplemodal.impl.init(a, b)
    };
    d.simplemodal.close = function () {
        d.simplemodal.impl.close()
    };
    d.simplemodal.focus = function (a) {
        d.simplemodal.impl.focus(a)
    };
    d.simplemodal.setContainerDimensions = function () {
        d.simplemodal.impl.setContainerDimensions()
    };
    d.simplemodal.setPosition = function () {
        d.simplemodal.impl.setPosition()
    };
    d.simplemodal.update = function (a, b) {
        d.simplemodal.impl.update(a,
        b)
    };
    d.fn.simplemodal = function (a) {
        return d.simplemodal.impl.init(this, a)
    };
    d.simplemodal.defaults = {
        appendTo: "body",
        focus: true,
        opacity: 50,
    ...
    d.simplemodal.impl = {
        ...
        init: function (a, b) {
            ...
            c.o = d.extend({}, d.simplemodal.defaults, b);
            c.zIndex = c.o.zIndex;
            c.occb = false;
            if (typeof a === "object") {
        ...
        create: function (a) {
            var b = this;
            f = b.getDimensions();
            if (b.o.simplemodal && k) b.d.iframe = d('<iframe src="javascript:false;"></iframe>').css(d.extend(b.o.iframeCss, {
                display: "none",
                opacity: 0,
                position: "fixed",
                height: f[0],
            ...
            b.d.overlay = d("<div></div>").attr("id", b.o.overlayId).addClass("simplemodal-overlay").css(d.extend(b.o.overlayCss, {
                ...
                height: b.o.simplemodal ? f[0] : 0,
                width: b.o.simplemodal ? f[1] : 0,
                position: "fixed",
                left: 0,
                top: 0,
                zIndex: b.o.zIndex + 1
        ...
        bindEvents: function () {
            ...
            a.o.simplemodal && a.o.close && a.o.overlayClose && a.d.overlay.bind("click.simplemodal", function (b) {
                b.preventDefault();
                a.close()
            });
            d(document).bind("keydown.simplemodal", function (b) {
                if (a.o.simplemodal && b.keyCode === 9) a.watchTab(b);
        ...
        fixIE: function () {
            var a = this,
                b = a.o.position;
            d.each([a.d.iframe || null, !a.o.simplemodal ? null : a.d.overlay, a.d.container], function (c, h) {
                if (h) {
                    var g = h[0].style;
                    g.position = "absolute";
                    if (c < 2) {
